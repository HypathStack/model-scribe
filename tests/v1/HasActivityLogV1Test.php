...
use App\Models\Backoffice\InternalUser;
...
use Mockery;
use Tests\Unit\InternalUserFactory;
...
class HasActivityLogV1Test extends TestCase
{
    ...
    protected function mockAuthManager(?string $defaultGuard = 'web'): void
    {
        ...
        $authMock = Mockery::mock(\Illuminate\Auth\AuthManager::class);
    ...
    public function test_activity_logs_relationship_works_with_valid_guard()
    {
        ...
        $this->assertInstanceOf(\Illuminate\Database\Eloquent\Relations\MorphMany::class, $logs);
